...
import sys
sys.path.append('/home/dennis/Media_HDD/ETH/Robot_Learning/DiffuseDrive_own/diffuser/models')
...
class FeatureExtractorDeeplabMobilenet(nn.Module):
    def __init__(self, pretrained=True, freeze=True):
        ...
        checkpoint = torch.load("/home/dennis/Media_HDD/ETH/Robot_Learning/best_deeplabv3plus_mobilenet_cityscapes_os16.pth", map_location=torch.device('cpu'))
